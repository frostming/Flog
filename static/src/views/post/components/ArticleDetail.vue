    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      <el-col :span="18">
        <el-form-item prop="content" style="margin-bottom: 30px;">
          <markdown-editor ref="editor" v-model="postForm.content" :options="{previewStyle: 'tab'}" height="800px" />
        </el-form-item>
      </el-col>
      <el-col :span="6">
        ...
        <el-form-item prop="image" style="margin-bottom: 30px;" label="Cover Image">
