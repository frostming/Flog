...
rsync -avz --delete --exclude='*.pyc' pyproject.toml pdm.lock ./docker-compose.yml Dockerfile \
    flaskblog migrations start_server.sh fming@frostming.com:/home/fming/frostming.com/
